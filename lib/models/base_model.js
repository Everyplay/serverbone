...
var BaseModel = SchemaModel.extend({
  ...
  save: function(key, val, options) {
    ...
    return this.preSave(_.clone(opts)).then(function() {
      return PromisedModel.prototype.save.call(self, key, _.clone(opts)).then(function(model) {
        return self.afterSave(_.clone(opts)).then(function() {
          return model;
        });
      });
    }, function(err) {
