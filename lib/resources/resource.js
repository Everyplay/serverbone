 ...
 * @param {Any} middleware list of Express-style middleware
...
Resource.prototype.initMiddlewares = function () {
...
Resource.prototype._initializeSchemaResponse = function () {
  ...
  this.app.get('/schema', function (req, res) {
    var admin = false;
...
Resource.prototype._mountRelations = function () {
  ...
  Object.keys(properties).forEach(function (propertyName) {
    ...
    if (mountRelation) {
      ...
      var callSubResource = function(req, res, next) {
        // fetch parent model if needed
        // TODO: this should be more clever to avoid unnecessary fetches
        // also fetch options should be configurable
        if (req.model && !req.model.promise && !req.model.isFetched()) {
...
Resource.prototype.errorHandler = function(err, req, res) {
...
Resource.prototype.getModelFetchOptions = function(req, res) {
  var fetchOptions = this.getProjectionOptions(req, res);
...
Resource.prototype.getProjectionOptions = function(req, res) {
  ...
  if (!res.locals.resource) {
    return this.errorHandler(new Error('Resource not found'), req, res);
  }
