...
Resource.prototype._mountRelations = function () {
  ...
  Object.keys(properties).forEach(function (propertyName) {
    ...
    if (mountRelation) {
      ...
      var ResourceClass = property.resourceType === 'list'
        ? serverbone.resources.ListResource
        : Resource;
...
Resource.prototype.create = function (req, res, next) {
  this._constructCollection(req).create(res.locals.resource.toJSON({actor: req.actor}), {wait: true, actor: req.actor})
  .done(function (model) {
